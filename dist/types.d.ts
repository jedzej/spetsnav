...
declare type ResolverFunc = (key: NAV_KEY, items: SpetsNavNode[], focusedNode: SpetsNavNode | null) => Promise<SpetsNavNode[]> | SpetsNavNode[];
declare type BeforeAfterCallback = () => Promise<void> | void;
...
export declare type SpetsNavBinding = (handleKey: (key: NAV_KEY) => Promise<void>) => () => void;
export {};
